...
#from firebaseConfig import ref não precisamos mais disto, pois temos o singleton
...
class SistemaEventos:
    ...
    def cancelar_evento(self):
        ...
        # 3. Enviar os e-mails
        if lista_emails:
            print(f"Criando {len(lista_emails)} notificação(ões) de cancelamento")
            mensagemNotificacao = f"O evento '{nome_evento}' foi cancelado."
            ...
            for email in lista_emails:
                ...
                self.notificacoes_ref.push(notificacao_data)
    ...
    def menu(self):
        while True:
            ...
            elif opc == '5': self.gerenciar_locais()
            elif opc == '0':
                print("Encerrando...")
                break
            else:
